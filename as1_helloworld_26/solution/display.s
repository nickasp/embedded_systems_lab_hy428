...
.L51:
	...
	b	.L49
.L50:
	.loc 1 289 23 discriminator 3
	ldrb	r3, [r7, #14]	@ zero_extendqisi2
	sub	r2, r3, #32
	.loc 1 289 29 discriminator 3
	mov	r3, r2
	lsls	r3, r3, #1
	add	r3, r3, r2
	lsls	r3, r3, #1
	mov	r2, r3
	.loc 1 289 36 discriminator 3
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	add	r3, r3, r2
	.loc 1 289 4 discriminator 3
	ldr	r2, .L52+4
	ldrb	r3, [r2, r3]	@ zero_extendqisi2
	mov	r0, r3
	bl	spi_send_8
	.loc 1 288 26 discriminator 3
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	adds	r3, r3, #1
	strb	r3, [r7, #15]
.L49:
...
.L52:
	...
	.cfi_endproc
.LFE12:
	.size	display_write, .-display_write
	.align	1
	.global	display_write_num
	.syntax unified
	.thumb
	.thumb_func
	.type	display_write_num, %function
display_write_num:
.LFB13:
	.loc 1 295 59
	.cfi_startproc
...
.L61:
	...
	.cfi_endproc
.LFE13:
	.size	display_write_num, .-display_write_num
.Letext0:
...
.LASF183:
	...
	.ascii	"signments/as1_helloworld/solution\000"
.LASF44:
	.ascii	"TWI0_IRQn\000"
.LASF187:
